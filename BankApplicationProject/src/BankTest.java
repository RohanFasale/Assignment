...
public class BankTest {
	public static void main(String[] args) {
		...
		BankAccount bankAcc = bank.applyForJointBankAccount(bankAppForm1, bankAppForm2);
...
class Bank{
	BankAccount applyForJointBankAccount(BankApplicationForm bankAppFormRef1,BankApplicationForm bankAppFormRef2) {
		System.out.println("Receiving The Application Form of joint account :");
		BankAccount bankAccJObj = new BankAccount();
		
		double value = Math.random() * 100;
		long accNum = (long) value;
		bankAccJObj.setAccountNumber(accNum); 
		bankAccJObj.setAccountHolder(bankAppFormRef1.getApplicantName()+"  "+bankAppFormRef2.getApplicantName());
		bankAccJObj.setAccountType(bankAppFormRef1.getAccountType());
		bankAccJObj.setIfscCode("BOB000000015");
		bankAccJObj.setAccountBalance(3000);
